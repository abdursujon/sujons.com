...
/**
 * Fetches skills data from JSON file and triggers rendering.
 */
function loadSkills() {
...
/**
 * Renders skill categories into the skills container element.
 */
function renderSkills(categories) {
  ...
  container.innerHTML = `
    ...
    <p class="text-center skills-subtitle">My technical & other skills</p>
...
/**
 * Generates HTML markup for a single skill category accordion.
 */
...
/**
 * Generates HTML markup for a single skill progress bar.
 */
...
/**
 * Maps icon type string to corresponding emoji.
 */
...
/**
 * Initializes accordion click handlers for skill categories.
 */
