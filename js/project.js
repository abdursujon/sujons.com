const projects = [
  {
    ...
    description:
      "Emilia's Della Roma is a portfolio project that replicates\n" +
    ...
    images: [
      ...
      "assets/projects/project 1/7.png",
      "assets/projects/project 1/8.png",
    ],
  },
  {
...

  {
    title: "Mew Mate",
    description:
      "A fun hobby project that replicates Tinder, but with a twist—it's a dating site for cats only! Swipe, match, and help your feline friend find the purr-fect partner, all while exploring a playful, interactive UI designed to showcase responsive design, animations, and creative web development skills.",
